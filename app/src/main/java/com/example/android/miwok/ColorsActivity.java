...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("dusty yellow", "tolookosu", R.drawable.color_dusty_yellow));
        words.add(new Word("gray", "oyyisa", R.drawable.color_gray));
        words.add(new Word("green", "massokka", R.drawable.color_green));
        words.add(new Word("mustard", "temmokka", R.drawable.color_mustard_yellow));
        words.add(new Word("black", "kenekaku", R.drawable.color_black));
